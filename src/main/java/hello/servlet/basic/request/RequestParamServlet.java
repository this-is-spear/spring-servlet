...
/**
 * Created by Imaspear on 2022-01-08
...
*   ㄴ RequestParamServlet.java
* </pre>
* @date : 2022-01-08 오후 10:27
* @author : ImaSpear
* @version : 1. 0. 0
* @description : 
...
public class RequestParamServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getParameterNames().asIterator()
                        .forEachRemaining(parmName -> System.out.println(parmName + ": " + request.getParameter(parmName)));
